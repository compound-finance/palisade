module Bootstrap.Carousel exposing
    ( Model(..), StateOptions, Transition(..), initialState, initialStateWithOptions, defaultStateOptions, Cycling(..)
...
-}
initialStateWithOptions : StateOptions -> Model 
...
-}
view : Model -> Config msg -> Html.Html msg
...
-}
viewSlide : Model -> Int -> Slide.Config msg -> Html.Html msg
